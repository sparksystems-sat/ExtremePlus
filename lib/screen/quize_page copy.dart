  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      "answer": 1,
      "explanation": "Correct: 'She doesn’t like apples.' because 'doesn't' is used with base verb."
    },
    {
    ...
    },
    {
      ...
      "answer": 2,
      "explanation": "'Book' is a noun. The others are verb, adverb, and adjective."
    },
    {
          ...
          ...List.generate(options.length, (optIndex) {
            ...
            if (selectedIndex != null) {
              if (optIndex == selectedIndex) {
                borderColor =
                    (optIndex == correctIndex) ? Colors.green : Colors.red;
